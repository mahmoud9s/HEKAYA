...
Partial Class High_Budget_Alex_Hotel_Royal_Chalet_Maamourah_Beach
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(High_Budget_Alex_Hotel_Royal_Chalet_Maamourah_Beach))
        Label9 = New Label()
        Label11 = New Label()
        Label10 = New Label()
        Label8 = New Label()
        ...
        Label9.Location = New Point(406, 798)
        Label9.Margin = New Padding(4, 0, 4, 0)
        Label9.Name = "Label9"
        Label9.Size = New Size(434, 184)
        Label9.TabIndex = 215
        Label9.Text = "Private balcony   " & vbCrLf & "Garden view Terrace    " & vbCrLf & "Pets allowed Free      " & vbCrLf & "public parking"
        ' 
        ' Label11
        ' 
        ...
        Label11.Location = New Point(70, 1122)
        Label11.Margin = New Padding(4, 0, 4, 0)
        Label11.Name = "Label11"
        Label11.Size = New Size(839, 92)
        Label11.TabIndex = 214
        Label11.Text = "Approximately $100–$150 per night per person" & vbCrLf & "depending on the season and room type."
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(70, 1065)
        Label10.Margin = New Padding(4, 0, 4, 0)
        Label10.Name = "Label10"
        Label10.Size = New Size(300, 55)
        ...
        Label8.Location = New Point(70, 798)
        Label8.Margin = New Padding(4, 0, 4, 0)
        Label8.Name = "Label8"
        Label8.Size = New Size(295, 230)
        Label8.TabIndex = 212
        Label8.Text = "Free Wi-Fi" & vbCrLf & "Air conditioning" & vbCrLf & "Private kitchen" & vbCrLf & "bathroom" & vbCrLf & "TV"
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(76, 742)
        Label7.Margin = New Padding(4, 0, 4, 0)
        Label7.Name = "Label7"
        Label7.Size = New Size(506, 55)
        Label7.TabIndex = 211
        ...
        LinkLabel1.Location = New Point(76, 262)
        LinkLabel1.Margin = New Padding(4, 0, 4, 0)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(582, 54)
        LinkLabel1.TabIndex = 209
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "Royal Chalet Maamourah Beach"
        ' 
        ' PictureBox6
        ' 
        ...
        PictureBox6.Location = New Point(23, 262)
        ...
        Label5.Font = New Font("Mongolian Baiti", 50F)
        Label5.ForeColor = Color.FromArgb(CByte(98), CByte(62), CByte(42))
        Label5.Location = New Point(76, 145)
        Label5.Margin = New Padding(4, 0, 4, 0)
        Label5.Name = "Label5"
        Label5.Size = New Size(1351, 106)
        Label5.TabIndex = 207
        Label5.Text = "Royal Chalet Maamourah Beach"
        ' 
        ' PictureBox5
        ' 
        PictureBox5.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        PictureBox5.Image = CType(resources.GetObject("PictureBox5.Image"), Image)
        PictureBox5.Location = New Point(611, 227)
        ...
        Label4.Location = New Point(160, 110)
        ...
        Label3.Name = "Label3"
        Label3.Size = New Size(356, 29)
        Label3.TabIndex = 204
        Label3.Text = "Royal Chalet Maamourah Beach"
        ' 
        ' Label1
        ' 
        ...
        Label12.Font = New Font("Microsoft Sans Serif", 20F)
        Label12.ForeColor = Color.FromArgb(CByte(98), CByte(62), CByte(42))
        Label12.Location = New Point(96, 1300)
        Label12.Margin = New Padding(4, 0, 4, 0)
        Label12.Name = "Label12"
        Label12.Size = New Size(739, 92)
        Label12.TabIndex = 216
        Label12.Text = "Check-in : 12:00 AM to 11:00 PM            " & vbCrLf & "Check-out : 10:00 AM to 11:00 AM"
        ' 
        ' Label13
        ' 
        Label13.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left
        Label13.AutoSize = True
        Label13.Font = New Font("Microsoft Sans Serif", 24F, FontStyle.Bold)
        Label13.ForeColor = Color.FromArgb(CByte(98), CByte(62), CByte(42))
        Label13.Location = New Point(70, 1243)
        Label13.Margin = New Padding(4, 0, 4, 0)
        Label13.Name = "Label13"
        Label13.Size = New Size(493, 55)
        Label13.TabIndex = 217
        Label13.Text = "Check-in/Check-out :"
        ' 
        ' Label2
        ' 
        ...
        Label2.Location = New Point(1787, 158)
        ...
        PictureBox4.Location = New Point(1694, 137)
        ...
        PictureBox3.Location = New Point(1530, 145)
        ...
        PictureBox2.Location = New Point(1609, 145)
        PictureBox2.Margin = New Padding(4, 3, 4, 3)
        PictureBox2.Name = "PictureBox2"
        PictureBox2.Size = New Size(66, 63)
        PictureBox2.TabIndex = 223
        ...
        PictureBox1.Location = New Point(1407, 155)
        ...
        PictureBox9.Location = New Point(1707, 18)
        ...
        PictureBox10.Location = New Point(1814, 18)
        ...
        ' 
        ' High_Budget_Alex_Hotel_Royal_Chalet_Maamourah_Beach
        ' 
        ...
        Name = "High_Budget_Alex_Hotel_Royal_Chalet_Maamourah_Beach"
        Text = "High_Budget_Alex_Hotel_Royal_Chalet_Maamourah_Beach"
