...
Partial Class Moderate_Budget_Alex_Hotel_Grand_Plaza_Hotel
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Moderate_Budget_Alex_Hotel_Grand_Plaza_Hotel))
        Label9 = New Label()
        Label11 = New Label()
        Label10 = New Label()
        Label8 = New Label()
        ...
        Label9.Location = New Point(402, 575)
        Label9.Name = "Label9"
        Label9.Size = New Size(444, 238)
        Label9.TabIndex = 171
        Label9.Text = "24-hour front desk and room service.                       Fitness center.               restaurant offering local and international cuisine."
        ' 
        ' Label11
        ' 
        ...
        Label11.Location = New Point(4, 902)
        Label11.Name = "Label11"
        Label11.Size = New Size(407, 91)
        Label11.TabIndex = 170
        Label11.Text = "Approximately $45–$90 per night per person, depending on room type and season."
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(4, 826)
        ...
        Label8.Location = New Point(12, 555)
        Label8.Name = "Label8"
        Label8.Size = New Size(356, 238)
        Label8.TabIndex = 168
        Label8.Text = "Spacious rooms and suites with city views    complimentary breakfast buffet        Free Wi-Fi        restaurants and cafés"
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(23, 498)
        Label7.Name = "Label7"
        ...
        Label6.Location = New Point(23, 314)
        Label6.Name = "Label6"
        ...
        LinkLabel1.Location = New Point(66, 262)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(287, 46)
        LinkLabel1.TabIndex = 165
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "Grand Plaza Hotel"
        ' 
        ' PictureBox6
        ' 
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(782, 106)
        Label5.TabIndex = 163
        Label5.Text = "Grand Plaza Hotel"
        ' 
        ' PictureBox5
        ' 
        PictureBox5.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        PictureBox5.Image = CType(resources.GetObject("PictureBox5.Image"), Image)
        PictureBox5.Location = New Point(750, 172)
        ...
        Label4.Location = New Point(161, 106)
        Label4.Name = "Label4"
        ...
        Label3.Location = New Point(264, 106)
        Label3.Name = "Label3"
        Label3.Size = New Size(170, 25)
        Label3.TabIndex = 160
        Label3.Text = "Grand Plaza Hotel"
        ' 
        ' Label2
        ' 
        ...
        Label2.Location = New Point(1647, 117)
        Label2.Name = "Label2"
        ...
        PictureBox4.Location = New Point(1616, 100)
        PictureBox4.Name = "PictureBox4"
        PictureBox4.Size = New Size(161, 93)
        PictureBox4.TabIndex = 158
        ...
        PictureBox3.Location = New Point(1599, 106)
        ...
        PictureBox2.Location = New Point(1664, 106)
        ...
        PictureBox1.Location = New Point(764, 100)
        ...
        PictureBox7.Location = New Point(103, 5)
        ...
        PictureBox9.Location = New Point(1684, 5)
        ...
        PictureBox10.Location = New Point(1712, 5)
        PictureBox10.Name = "PictureBox10"
        PictureBox10.Size = New Size(63, 89)
        PictureBox10.TabIndex = 150
        PictureBox10.TabStop = False
        ' 
        ' Moderate_Budget_Alex_Hotel_Grand_Plaza_Hotel
        ' 
        ...
        Name = "Moderate_Budget_Alex_Hotel_Grand_Plaza_Hotel"
        Text = "Moderate_Budget_Alex_Hotel_Grand_Plaza_Hotel"
