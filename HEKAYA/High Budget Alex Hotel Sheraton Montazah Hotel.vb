Public Class High_Budget_Alex_Hotel_Sheraton_Montazah_Hotel
    ...
    Private Sub High_Budget_Alex_Hotel_Sheraton_Montazah_Hotel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
