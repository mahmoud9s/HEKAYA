Public Class Restaurants_Hurghada_Star_Fish_Restaurant
    ...
    Private Sub Restaurants_Hurghada_Star_Fish_Restaurant_Load(sender As Object, e As EventArgs) Handles MyBase.Load
