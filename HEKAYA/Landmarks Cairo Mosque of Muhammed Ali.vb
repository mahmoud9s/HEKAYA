Public Class Landmarks_Cairo_Mosque_of_Muhammed_Ali
    ...
    Private Sub Landmarks_Cairo_Mosque_of_Muhammed_Ali_Load(sender As Object, e As EventArgs) Handles MyBase.Load
