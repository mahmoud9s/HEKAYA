Public Class Moderate_Budget_Cairo_Hotels_Concorde_El_Salam
    ...
    Private Sub Moderate_Budget_Cairo_Hotels_Concorde_El_Salam_Load(sender As Object, e As EventArgs) Handles MyBase.Load
