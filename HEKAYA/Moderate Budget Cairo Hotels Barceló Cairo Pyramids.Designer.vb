...
Partial Class Moderate_Budget_Cairo_Hotels_Barceló_Cairo_Pyramids
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Moderate_Budget_Cairo_Hotels_Barceló_Cairo_Pyramids))
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        Label8 = New Label()
        ...
        Label11.Size = New Size(268, 31)
        Label11.TabIndex = 146
        Label11.Text = "$65 to $100 per night"
        ' 
        ' Label10
        ' 
        ...
        Label9.TabIndex = 144
        Label9.Text = "Fitness center" & vbCrLf & "Tea/Coffee Maker in All Rooms" & vbCrLf & "Bar" & vbCrLf & "Good Breakfast" & vbCrLf & vbCrLf & vbCrLf
        ' 
        ' Label8
        ' 
        ...
        Label8.TabIndex = 143
        Label8.Text = "Outdoor swimming pool" & vbCrLf & "Free Wifi" & vbCrLf & "Airport shuttle" & vbCrLf & "Family rooms" & vbCrLf & "Free parking" & vbCrLf & "Spa" & vbCrLf
        ' 
        ' Label7
        ' 
        ...
        LinkLabel1.Size = New Size(689, 37)
        LinkLabel1.TabIndex = 140
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "229 Pyramids Road, Giza, 12111 Cairo, Egypt- show map"
        ' 
        ' PictureBox6
        ' 
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(872, 91)
        Label5.TabIndex = 138
        Label5.Text = "Barceló Cairo Pyramids"
        ' 
        ' PictureBox5
        ' 
        ...
        Label3.TabIndex = 135
        Label3.Text = "Barceló Cairo Pyramids"
        ' 
        ' Label2
        ' 
        ...
        ' 
        ' Moderate_Budget_Cairo_Hotels_Barceló_Cairo_Pyramids
        ' 
        ...
        Name = "Moderate_Budget_Cairo_Hotels_Barceló_Cairo_Pyramids"
        Text = "Moderate_Budget_Cairo_Hotels_Barceló_Cairo_Pyramids"
