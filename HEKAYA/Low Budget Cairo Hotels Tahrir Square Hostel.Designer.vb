...
Partial Class Low_Budget_Cairo_Hotels_Tahrir_Square_Hostel
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Low_Budget_Cairo_Hotels_Tahrir_Square_Hostel))
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        Label8 = New Label()
        ...
        Label11.Location = New Point(62, 924)
        Label11.Name = "Label11"
        Label11.Size = New Size(253, 31)
        Label11.TabIndex = 80
        Label11.Text = "$10 to $35 per night"
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(62, 876)
        ...
        Label9.Location = New Point(363, 618)
        Label9.Name = "Label9"
        Label9.Size = New Size(289, 192)
        Label9.TabIndex = 78
        Label9.Text = "Laundry" & vbCrLf & "Daily housekeeping" & vbCrLf & "Tea/Coffee Maker in All Rooms" & vbCrLf & "Wonderful Breakfast" & vbCrLf & vbCrLf
        ' 
        ' Label8
        ' 
        ...
        Label8.Location = New Point(62, 618)
        Label8.Name = "Label8"
        Label8.Size = New Size(279, 236)
        Label8.TabIndex = 77
        Label8.Text = "Free Wifi" & vbCrLf & "Airport shuttle" & vbCrLf & "Non-smoking rooms" & vbCrLf & "Room service" & vbCrLf & "24-hour front desk" & vbCrLf & "Terrace" & vbCrLf & vbCrLf
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(53, 569)
        Label7.Name = "Label7"
        ...
        LinkLabel1.Size = New Size(757, 37)
        LinkLabel1.TabIndex = 74
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "11 Tahrir Square, Second floor , 11512 Cairo, Egypt- show map"
        ' 
        ' PictureBox6
        ' 
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(770, 91)
        Label5.TabIndex = 72
        Label5.Text = "Tahrir Square Hostel"
        ' 
        ' PictureBox5
        ' 
        ...
        Label3.TabIndex = 69
        Label3.Text = "Tahrir Square Hostel"
        ' 
        ' Label2
        ' 
        ...
        ' 
        ' Low_Budget_Cairo_Hotels_Tahrir_Square_Hostel
        ' 
        ...
        Name = "Low_Budget_Cairo_Hotels_Tahrir_Square_Hostel"
        Text = "Low_Budget_Cairo_Hotels_Tahrir_Square_Hostel"
