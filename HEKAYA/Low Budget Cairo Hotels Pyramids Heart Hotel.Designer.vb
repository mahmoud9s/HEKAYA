...
Partial Class Low_Budget_Cairo_Hotels_Pyramids_Heart_Hotel
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Low_Budget_Cairo_Hotels_Pyramids_Heart_Hotel))
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        Label8 = New Label()
        ...
        Label11.Location = New Point(61, 896)
        Label11.Name = "Label11"
        Label11.Size = New Size(253, 31)
        Label11.TabIndex = 102
        Label11.Text = "$40 to $45 per night"
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(61, 848)
        ...
        Label9.Location = New Point(369, 606)
        Label9.Name = "Label9"
        Label9.Size = New Size(408, 192)
        Label9.TabIndex = 100
        Label9.Text = "Room service" & vbCrLf & "24-hour front desk" & vbCrLf & "Tea/Coffee Maker in All Rooms" & vbCrLf & "Good Breakfast" & vbCrLf
        ' 
        ' Label8
        ' 
        ...
        Label8.Location = New Point(61, 606)
        Label8.Name = "Label8"
        Label8.Size = New Size(273, 226)
        Label8.TabIndex = 99
        Label8.Text = "Free Wifi" & vbCrLf & "Airport shuttle" & vbCrLf & "Family rooms" & vbCrLf & "Free parking" & vbCrLf & "Restaurant" & vbCrLf & "Non-smoking rooms" & vbCrLf
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(52, 556)
        Label7.Name = "Label7"
        ...
        Label6.TabIndex = 97
        Label6.Text = "Pyramids Heart Hotel in Cairo offers air-conditioned rooms, free WiFi, breakfast options, and a terrace. It’s near the Great Sphinx and Giza Pyramids, 20 miles from Cairo Airport."
        ' 
        ' LinkLabel1
        ' 
        LinkLabel1.AutoSize = True
        LinkLabel1.Font = New Font("Segoe UI", 20F)
        LinkLabel1.Location = New Point(92, 227)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(547, 37)
        LinkLabel1.TabIndex = 96
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "Al Mansoureya Road, Giza, Egypt- show map"
        ' 
        ' PictureBox6
        ' 
        ...
        PictureBox6.Location = New Point(52, 227)
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(793, 91)
        Label5.TabIndex = 94
        Label5.Text = "Pyramids Heart Hotel"
        ' 
        ' PictureBox5
        ' 
        ...
        Label3.Location = New Point(129, 64)
        Label3.Name = "Label3"
        Label3.Size = New Size(159, 20)
        Label3.TabIndex = 91
        Label3.Text = "Pyramids Heart Hotel"
        ' 
        ' Label2
        ' 
        ...
        Label2.Location = New Point(1746, 85)
        Label2.Name = "Label2"
        ...
        PictureBox4.Location = New Point(1723, 72)
        ...
        PictureBox3.Location = New Point(1666, 76)
        ...
        PictureBox2.Location = New Point(1604, 76)
        ...
        PictureBox1.Location = New Point(976, 76)
        ...
        PictureBox7.Location = New Point(97, 11)
        ...
        PictureBox9.Location = New Point(1746, 11)
        ...
        PictureBox10.Location = New Point(1821, 11)
        ...
        ' 
        ' Low_Budget_Cairo_Hotels_Pyramids_Heart_Hotel
        ' 
        ...
        Name = "Low_Budget_Cairo_Hotels_Pyramids_Heart_Hotel"
        Text = "Low_Budget_Cairo_Hotels_Pyramids_Heart_Hotel"
