...
Partial Class Hotels_Hurghada_Small_Budget
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Hotels_Hurghada_Small_Budget))
        Label14 = New Label()
        ...
        Label14.Location = New Point(461, 282)
        ...
        PictureBox12.Location = New Point(381, 219)
        ...
        Label7.Location = New Point(1252, 939)
        Label7.Name = "Label7"
        Label7.Size = New Size(459, 279)
        Label7.TabIndex = 119
        Label7.Text = "Sand Beach Resort offers a pool, diving center, and air-conditioned rooms by Hurghada Beach. Dining includes buffets, pizza, and cocktails. Guests can relax or enjoy massages and a disco."
        ' 
        ' Label9
        ' 
        ...
        Label9.Location = New Point(578, 939)
        Label9.Name = "Label9"
        Label9.Size = New Size(423, 279)
        Label9.TabIndex = 118
        Label9.Text = "Luxor Hotel Hurghada offers air-conditioned rooms, a restaurant, and a 24-hour front desk. It’s near Elysees Dream Beach and 9 km from Hurghada Airport, with a paid shuttle service."
        ' 
        ' Label12
        ' 
        ...
        Label12.Location = New Point(1696, 863)
        Label12.Name = "Label12"
        Label12.Size = New Size(397, 48)
        Label12.TabIndex = 117
        Label12.Text = "Sand Beach Resort"
        ' 
        ' Label13
        ' 
        ...
        Label13.Location = New Point(578, 863)
        Label13.Name = "Label13"
        Label13.Size = New Size(446, 48)
        Label13.TabIndex = 116
        Label13.Text = "Luxor Hotel Hurghada"
        ' 
        ' PictureBox9
        ' 
        ...
        PictureBox9.Location = New Point(1222, 854)
        PictureBox9.Name = "PictureBox9"
        PictureBox9.Size = New Size(457, 363)
        PictureBox9.TabIndex = 115
        ...
        PictureBox11.Location = New Point(96, 854)
        PictureBox11.Name = "PictureBox11"
        PictureBox11.Size = New Size(457, 363)
        ...
        Label11.Location = New Point(1434, 542)
        Label11.Name = "Label11"
        Label11.Size = New Size(459, 215)
        Label11.TabIndex = 113
        Label11.Text = "Golden Rose Hotel in Hurghada’s Sakala district is 200 meters from the Red Sea. It offers rooms with satellite TVs and organizes activities like diving, windsurfing, and snorkeling."
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(578, 542)
        Label10.Name = "Label10"
        Label10.Size = New Size(441, 215)
        Label10.TabIndex = 112
        Label10.Text = "Jaz Aquamarina Resort in Hurghada features a private beach, 20 pools, 9 restaurants, and evening live entertainment. Rooms offer sea or pool views, with family rooms providing living areas."
        ' 
        ' Label8
        ' 
        ...
        Label8.Location = New Point(1686, 458)
        Label8.Name = "Label8"
        Label8.Size = New Size(389, 48)
        Label8.TabIndex = 111
        Label8.Text = "Golden Rose Hotel"
        ' 
        ' Label6
        ' 
        ...
        Label6.Location = New Point(578, 458)
        Label6.Name = "Label6"
        Label6.Size = New Size(476, 48)
        Label6.TabIndex = 110
        Label6.Text = "Jaz Aquamarine Resort"
        ' 
        ' PictureBox10
        ' 
        ...
        PictureBox10.Location = New Point(1222, 435)
        PictureBox10.Name = "PictureBox10"
        PictureBox10.Size = New Size(457, 363)
        ...
        PictureBox3.Location = New Point(96, 435)
        PictureBox3.Name = "PictureBox3"
        PictureBox3.Size = New Size(457, 363)
        ...
        PictureBox8.Location = New Point(6, 17)
        ...
        PictureBox6.Location = New Point(104, 17)
        ...
        PictureBox7.Location = New Point(1754, 17)
        ...
        PictureBox5.Location = New Point(1648, 17)
        ...
        Label4.Location = New Point(1438, 282)
        Label4.Name = "Label4"
        ...
        Label3.Location = New Point(1068, 282)
        Label3.Name = "Label3"
        ...
        Label2.Location = New Point(765, 282)
        Label2.Name = "Label2"
        ...
        PictureBox2.Location = New Point(1051, 219)
        ...
        PictureBox1.Location = New Point(1384, 219)
        ...
        PictureBox4.Location = New Point(715, 219)
        ...
        Label1.Location = New Point(815, 94)
        Label1.Name = "Label1"
        Label1.Size = New Size(800, 106)
        Label1.TabIndex = 97
        Label1.Text = "Hotels and Resorts"
        ' 
        ' Hotels_Hurghada_Small_Budget
        ' 
        ...
        Name = "Hotels_Hurghada_Small_Budget"
        Text = "Hotels_Hurghada_Small_Budget"
