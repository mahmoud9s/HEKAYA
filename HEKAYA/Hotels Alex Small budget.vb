Public Class Hotels_Alex_Small_budget
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        Low_Budget_Alex_Hotel_Alexander_the_Great_Hotel.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub PictureBox11_Click(sender As Object, e As EventArgs) Handles PictureBox11.Click
        Low_Budget_Alex_Hotel_Flores_Casas_de_Playa.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub PictureBox10_Click(sender As Object, e As EventArgs) Handles PictureBox10.Click
        Low_Budget_Alex_Hotel_Charming_Miramar_Aparthotel.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub PictureBox9_Click(sender As Object, e As EventArgs) Handles PictureBox9.Click
        Low_Budget_Alex_Hotel_Hyat_Suites___Rooms.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Hotels_Alex_Small_budget_Load(sender As Object, e As EventArgs) Handles MyBase.Load
