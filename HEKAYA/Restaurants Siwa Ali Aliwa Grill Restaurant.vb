Public Class Restaurants_Siwa_Ali_Aliwa_Grill_Restaurant
    ...
    Private Sub Restaurants_Siwa_Ali_Aliwa_Grill_Restaurant_Load(sender As Object, e As EventArgs) Handles MyBase.Load
