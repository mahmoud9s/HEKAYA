Public Class High_Budget_Alex_Hotel_Royal_Chalet_Maamourah_Beach
    Private Sub High_Budget_Alex_Hotel_Royal_Chalet_Maamourah_Beach_Load(sender As Object, e As EventArgs)
    ...
    Private Sub High_Budget_Alex_Hotel_Royal_Chalet_Maamourah_Beach_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
