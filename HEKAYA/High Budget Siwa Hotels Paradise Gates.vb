Public Class High_Budget_Siwa_Hotels_Paradise_Gates
    ...
    Private Sub High_Budget_Siwa_Hotels_Paradise_Gates_Load(sender As Object, e As EventArgs) Handles MyBase.Load
