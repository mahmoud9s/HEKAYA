Public Class Hotels_Siwa_Moderate_Budget
    ...
    Private Sub Hotels_Siwa_Moderate_Budget_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        AddPageToHistory(Me.Name)
    End Sub

    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        Moderate_Budget_Siwa_Hotel_Ayur_Resort.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub PictureBox11_Click(sender As Object, e As EventArgs) Handles PictureBox11.Click
        Moderate_Budget_Siwa_Hotel_Baben_Home.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub PictureBox10_Click(sender As Object, e As EventArgs) Handles PictureBox10.Click
        Moderate_Budget_Siwa_Hotel_ECO_ROOMS_Siwa.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub PictureBox9_Click(sender As Object, e As EventArgs) Handles PictureBox9.Click
        Moderate_Budget_Siwa_Hotel_Moon_Valley_Siwa.Show()
        Me.Hide()
    End Sub
