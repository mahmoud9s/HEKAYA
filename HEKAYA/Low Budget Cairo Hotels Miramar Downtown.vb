Public Class Low_Budget_Cairo_Hotels_Miramar_Downtown
    ...
    Private Sub Low_Budget_Cairo_Hotels_Miramar_Downtown_Load(sender As Object, e As EventArgs) Handles MyBase.Load
