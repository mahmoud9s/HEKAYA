...
Partial Class Moderate_Budget_Cairo_Hotels_Al_Masa
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Moderate_Budget_Cairo_Hotels_Al_Masa))
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        Label8 = New Label()
        ...
        Label11.Text = "$85 to $128 per night"
        ' 
        ' Label10
        ' 
        ...
        Label9.TabIndex = 122
        Label9.Text = "Free Wifi" & vbCrLf & "Airport shuttle" & vbCrLf & "Free parking" & vbCrLf & "Spa" & vbCrLf & vbCrLf & vbCrLf & vbCrLf
        ' 
        ' Label8
        ' 
        ...
        Label8.TabIndex = 121
        Label8.Text = "Outdoor swimming pool" & vbCrLf & "Fitness center" & vbCrLf & "Restaurant" & vbCrLf & "Tea/Coffee Maker in All Rooms" & vbCrLf & "Bar" & vbCrLf & "Good Breakfast" & vbCrLf & vbCrLf
        ' 
        ' Label7
        ' 
        ...
        LinkLabel1.Size = New Size(789, 37)
        LinkLabel1.TabIndex = 118
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "Abdel Aziz El Shennawy Street, Nasr City, Cairo, Egypt- show map"
        ' 
        ' PictureBox6
        ' 
        ...
        Label3.Location = New Point(143, 64)
        Label3.Name = "Label3"
        ...
        ' 
        ' Moderate_Budget_Cairo_Hotels_Al_Masa
        ' 
        ...
        Name = "Moderate_Budget_Cairo_Hotels_Al_Masa"
        Text = "Moderate_Budget_Cairo_Hotels_Al_Masa"
