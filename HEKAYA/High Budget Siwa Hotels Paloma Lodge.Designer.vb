...
Partial Class High_Budget_Siwa_Hotels_Paloma_Lodge
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(High_Budget_Siwa_Hotels_Paloma_Lodge))
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        Label8 = New Label()
        ...
        Label11.Location = New Point(65, 820)
        Label11.Name = "Label11"
        Label11.Size = New Size(260, 31)
        Label11.TabIndex = 124
        Label11.Text = "$50 to $70  per night"
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(65, 772)
        ...
        Label9.Location = New Point(352, 530)
        Label9.Name = "Label9"
        Label9.Size = New Size(463, 186)
        Label9.TabIndex = 122
        Label9.Text = "Private Bathrooms: " & vbCrLf & "Equipped with all basic amenities." & vbCrLf & "Traditional Siwan Decor:" & vbCrLf & " Rooms are designed " & vbCrLf & "with local materials and furnishings," & vbCrLf & " offering a true taste of Siwan culture."
        ' 
        ' Label8
        ' 
        ...
        Label8.Location = New Point(65, 530)
        Label8.Name = "Label8"
        Label8.Size = New Size(281, 217)
        Label8.TabIndex = 121
        Label8.Text = "Free Wi-Fi: " & vbCrLf & "Family rooms" & vbCrLf & "Pet-Friendly: " & vbCrLf & "Pets are allowed " & vbCrLf & "without extra charges," & vbCrLf & "making it ideal " & vbCrLf & "for travelers with pets." & vbCrLf
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(57, 480)
        Label7.Name = "Label7"
        ...
        LinkLabel1.Size = New Size(872, 15)
        LinkLabel1.TabIndex = 118
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "The lodge is located just minutes from key historical sites, making it an excellent choice for visitors who want to experience the natural and cultural wonders of Siwa."
        ' 
        ' PictureBox6
        ' 
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(523, 85)
        Label5.TabIndex = 116
        Label5.Text = "Paloma Lodge "
        ' 
        ' PictureBox5
        ' 
        ...
        ' 
        ' High_Budget_Siwa_Hotels_Paloma_Lodge
        ' 
        ...
        Name = "High_Budget_Siwa_Hotels_Paloma_Lodge"
        Text = "High_Budget_Siwa_Hotels_Paloma_Lodge"
