Public Class Moderate_Budget_Cairo_Hotels_Barceló_Cairo_Pyramids
    ...
    Private Sub Moderate_Budget_Cairo_Hotels_Barceló_Cairo_Pyramids_Load(sender As Object, e As EventArgs) Handles MyBase.Load
