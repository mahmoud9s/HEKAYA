...
Partial Class Moderate_Budget_Cairo_Hotels_Novotel_Cairo_El_Borg
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Moderate_Budget_Cairo_Hotels_Novotel_Cairo_El_Borg))
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        Label8 = New Label()
        ...
        Label11.Text = "$67 to $110 per night" & vbCrLf
        ' 
        ' Label10
        ' 
        ...
        Label9.TabIndex = 144
        Label9.Text = "Restaurant" & vbCrLf & "Tea/Coffee Maker in All Rooms" & vbCrLf & "Bar" & vbCrLf & "Good Breakfast" & vbCrLf
        ' 
        ' Label8
        ' 
        ...
        Label8.TabIndex = 143
        Label8.Text = "Outdoor swimming pool" & vbCrLf & "Free Wifi" & vbCrLf & "Family rooms" & vbCrLf & "Private Parking" & vbCrLf & "Spa" & vbCrLf & "Fitness center" & vbCrLf
        ' 
        ' Label7
        ' 
        ...
        LinkLabel1.Text = "Saray El Gezirah, Zamalek, Cairo, Egypt- show map"
        ' 
        ' PictureBox6
        ' 
        ...
        Label3.TabIndex = 135
        Label3.Text = "Novotel Cairo El Borg"
        ' 
        ' Label2
        ' 
        ...
        ' 
        ' Moderate_Budget_Cairo_Hotels_Novotel_Cairo_El_Borg
        ' 
        ...
        Name = "Moderate_Budget_Cairo_Hotels_Novotel_Cairo_El_Borg"
        Text = "Moderate_Budget_Cairo_Hotels_Novotel_Cairo_El_Borg"
