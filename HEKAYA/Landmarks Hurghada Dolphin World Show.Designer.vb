...
Partial Class Landmarks_Hurghada_Dolphin_World_Show
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Landmarks_Hurghada_Dolphin_World_Show))
        Label17 = New Label()
        ...
        Label17.Location = New Point(1800, 102)
        ...
        PictureBox4.Location = New Point(1762, 85)
        ...
        PictureBox2.Location = New Point(1620, 94)
        ...
        PictureBox3.Location = New Point(1693, 92)
        ...
        Label8.Location = New Point(14, 608)
        Label8.Name = "Label8"
        Label8.Size = New Size(502, 558)
        Label8.TabIndex = 319
        Label8.Text = "Hotel pickup and drop-off" & vbCrLf & "Food and drinks" & vbCrLf & "Optional swimming / Photos with dolphins can be booked on spot there" & vbCrLf & vbCrLf
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(23, 562)
        Label7.Name = "Label7"
        Label7.Size = New Size(176, 46)
        Label7.TabIndex = 318
        Label7.Text = "Includes"
        ' 
        ' Label4
        ' 
        ...
        Label4.Location = New Point(136, 92)
        Label4.Name = "Label4"
        ...
        Label3.Location = New Point(262, 92)
        Label3.Name = "Label3"
        Label3.Size = New Size(195, 25)
        Label3.TabIndex = 316
        Label3.Text = "Dolphin World Show "
        ' 
        ' Label6
        ' 
        ...
        LinkLabel1.Location = New Point(54, 246)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(842, 46)
        LinkLabel1.TabIndex = 314
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "Dolphine show, Red Sea Governorate, Egypt-show map"
        ' 
        ' PictureBox6
        ' 
        ...
        PictureBox6.Location = New Point(-4, 246)
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(727, 82)
        Label5.TabIndex = 312
        Label5.Text = "Dolphin World Show "
        ' 
        ' PictureBox5
        ' 
        PictureBox5.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        PictureBox5.Image = CType(resources.GetObject("PictureBox5.Image"), Image)
        PictureBox5.Location = New Point(825, 158)
        ...
        Label2.Location = New Point(1785, 92)
        Label2.Name = "Label2"
        ...
        PictureBox1.Location = New Point(1124, 102)
        ...
        PictureBox7.Location = New Point(108, 8)
        ...
        PictureBox9.Location = New Point(1756, 8)
        ...
        PictureBox10.Location = New Point(1842, 8)
        PictureBox10.Name = "PictureBox10"
        PictureBox10.Size = New Size(63, 51)
        PictureBox10.TabIndex = 304
        PictureBox10.TabStop = False
        ' 
        ' Landmarks_Hurghada_Dolphin_World_Show
        ' 
        ...
        Name = "Landmarks_Hurghada_Dolphin_World_Show"
        Text = "Landmarks_Hurghada_Dolphin_World_Show"
