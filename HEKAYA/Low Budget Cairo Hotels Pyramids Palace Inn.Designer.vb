...
Partial Class Low_Budget_Cairo_Hotels_Pyramids_Palace_Inn
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Low_Budget_Cairo_Hotels_Pyramids_Palace_Inn))
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        Label8 = New Label()
        ...
        Label11.TabIndex = 80
        Label11.Text = "$30 to $50 per night"
        ' 
        ' Label10
        ' 
        ...
        Label9.TabIndex = 78
        Label9.Text = "Terrace" & vbCrLf & "Tea/Coffee Maker in All Rooms" & vbCrLf & "Exceptional Breakfast" & vbCrLf & vbCrLf
        ' 
        ' Label8
        ' 
        ...
        Label8.TabIndex = 77
        Label8.Text = "Free Wifi" & vbCrLf & "Airport shuttle" & vbCrLf & "Family rooms" & vbCrLf & "Free parking" & vbCrLf & "Non-smoking rooms" & vbCrLf & "Room service" & vbCrLf & "24-hour front desk" & vbCrLf
        ' 
        ' Label7
        ' 
        ...
        LinkLabel1.Text = "Al Amira Fadia, Giza, 12557 Cairo, Egypt- show map"
        ' 
        ' PictureBox6
        ' 
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(765, 91)
        Label5.TabIndex = 72
        Label5.Text = "Pyramids Palace Inn"
        ' 
        ' PictureBox5
        ' 
        ...
        Label3.Location = New Point(131, 64)
        Label3.Name = "Label3"
        Label3.Size = New Size(152, 20)
        Label3.TabIndex = 69
        Label3.Text = "Pyramids Palace Inn"
        ' 
        ' Label2
        ' 
        ...
        ' 
        ' Low_Budget_Cairo_Hotels_Pyramids_Palace_Inn
        ' 
        ...
        Name = "Low_Budget_Cairo_Hotels_Pyramids_Palace_Inn"
        Text = "Low_Budget_Cairo_Hotels_Pyramids_Palace_Inn"
