...
Partial Class Low_Budget_Cairo_Hotels_Miramar_Downtown
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Low_Budget_Cairo_Hotels_Miramar_Downtown))
        ...
        Label3.Location = New Point(132, 64)
        Label3.Name = "Label3"
        Label3.Size = New Size(145, 20)
        Label3.TabIndex = 46
        Label3.Text = "Miramar Downtown"
        ' 
        ' Label4
        ' 
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(725, 91)
        Label5.TabIndex = 49
        Label5.Text = "Miramar Downtown" & vbCrLf
        ' 
        ' PictureBox6
        ' 
        ...
        LinkLabel1.Size = New Size(541, 37)
        LinkLabel1.TabIndex = 52
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "164 El Tahrir, 11513 Cairo, Egypt- show map"
        ' 
        ' Label6
        ' 
        ...
        Label7.Font = New Font("Mongolian Baiti", 24F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label7.ForeColor = Color.FromArgb(CByte(98), CByte(62), CByte(42))
        Label7.Location = New Point(53, 556)
        Label7.Name = "Label7"
        Label7.Size = New Size(327, 34)
        Label7.TabIndex = 54
        ...
        Label8.TabIndex = 55
        Label8.Text = "Free Wifi" & vbCrLf & "Airport shuttle" & vbCrLf & "Family rooms" & vbCrLf & "Restaurant" & vbCrLf & "Non-smoking rooms" & vbCrLf & "Room service"
        ' 
        ' Label9
        ' 
        ...
        Label9.Name = "Label9"
        Label9.Size = New Size(214, 192)
        Label9.TabIndex = 56
        Label9.Text = "24-hour front desk" & vbCrLf & "Terrace" & vbCrLf & "Laundry" & vbCrLf & "Good Breakfast" & vbCrLf
        ' 
        ' Label10
        ' 
        ...
        Label11.TabIndex = 58
        Label11.Text = "$45 to $80 per night"
        ' 
        ' Low_Budget_Cairo_Hotels_Miramar_Downtown
        ' 
        ...
        Name = "Low_Budget_Cairo_Hotels_Miramar_Downtown"
        Text = "Low_Budget_Cairo_Hotels_Miramar_Downtown"
