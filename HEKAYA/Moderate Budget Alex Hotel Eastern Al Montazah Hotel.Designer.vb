...
Partial Class Moderate_Budget_Alex_Hotel_Eastern_Al_Montazah_Hotel
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Moderate_Budget_Alex_Hotel_Eastern_Al_Montazah_Hotel))
        Label9 = New Label()
        Label11 = New Label()
        Label10 = New Label()
        Label8 = New Label()
        ...
        Label9.Location = New Point(295, 541)
        Label9.Name = "Label9"
        Label9.Size = New Size(407, 238)
        Label9.TabIndex = 125
        Label9.Text = "Gym and a spa offering massages                business center      On-site restaurant serving  luggage storage"
        ' 
        ' Label11
        ' 
        ...
        Label11.Location = New Point(4, 829)
        Label11.Name = "Label11"
        Label11.Size = New Size(939, 91)
        Label11.TabIndex = 124
        Label11.Text = "Prices range from $40 to $70 per night, depending on room type and season."
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(4, 783)
        ...
        Label8.Location = New Point(4, 531)
        Label8.Name = "Label8"
        Label8.Size = New Size(339, 238)
        Label8.TabIndex = 122
        Label8.Text = "hairdryers" & vbCrLf & " Air-conditioned           rooms                 safes               Outdoor pool           sauna  "
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(23, 485)
        Label7.Name = "Label7"
        ...
        Label6.TabIndex = 120
        Label6.Text = "Situated near the Montazah Royal Gardens and close to Mamoura Beach, the hotel is in a quieter area but still accessible to key attractions like the Catacombs of Kom El Shoqafa (15 km away)."
        ' 
        ' LinkLabel1
        ' 
        LinkLabel1.AutoSize = True
        LinkLabel1.Font = New Font("Segoe UI", 20F)
        LinkLabel1.Location = New Point(66, 259)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(418, 46)
        LinkLabel1.TabIndex = 119
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "Eastern Al Montazah Hotel"
        ' 
        ' PictureBox6
        ' 
        ...
        PictureBox6.Location = New Point(23, 259)
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(1140, 106)
        Label5.TabIndex = 117
        Label5.Text = "Eastern Al Montazah Hotel"
        ' 
        ' PictureBox5
        ' 
        PictureBox5.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        PictureBox5.Image = CType(resources.GetObject("PictureBox5.Image"), Image)
        PictureBox5.Location = New Point(750, 169)
        ...
        Label4.Location = New Point(161, 103)
        Label4.Name = "Label4"
        ...
        Label3.TabIndex = 114
        Label3.Text = "Eastern Al Montazah Hotel"
        ' 
        ' Label2
        ' 
        ...
        Label2.Location = New Point(1647, 114)
        Label2.Name = "Label2"
        ...
        PictureBox4.Location = New Point(1616, 97)
        PictureBox4.Name = "PictureBox4"
        PictureBox4.Size = New Size(161, 93)
        PictureBox4.TabIndex = 112
        ...
        PictureBox3.Location = New Point(1599, 103)
        ...
        PictureBox2.Location = New Point(1664, 103)
        ...
        PictureBox1.Location = New Point(764, 97)
        ...
        PictureBox8.Location = New Point(4, 2)
        ...
        PictureBox7.Location = New Point(103, 2)
        ...
        PictureBox9.Location = New Point(1684, 2)
        ...
        PictureBox10.Location = New Point(1712, 2)
        ...
        Label12.Location = New Point(12, 920)
        Label12.Name = "Label12"
        Label12.Size = New Size(412, 46)
        ...
        Label13.Location = New Point(23, 979)
        Label13.Name = "Label13"
        Label13.Size = New Size(376, 45)
        Label13.TabIndex = 127
        Label13.Text = "Phone: +20 3 5623900"
        ' 
        ' Moderate_Budget_Alex_Hotel_Eastern_Al_Montazah_Hotel
        ' 
        ...
        Name = "Moderate_Budget_Alex_Hotel_Eastern_Al_Montazah_Hotel"
        Text = "Moderate_Budget_Alex_Hotel_Eastern_Al_Montazah_Hotel"
