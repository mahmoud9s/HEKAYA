Public Class Landmarks_Hurghada_Paradise_Island
    ...
    Private Sub Landmarks_Hurghada_Paradise_Island_Load(sender As Object, e As EventArgs) Handles MyBase.Load
