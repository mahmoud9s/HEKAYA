...
Partial Class Low_Budget_Alex_Hotel_Charming_Miramar_Aparthotel
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Low_Budget_Alex_Hotel_Charming_Miramar_Aparthotel))
        Label9 = New Label()
        Label11 = New Label()
        Label10 = New Label()
        Label8 = New Label()
        ...
        Label9.Location = New Point(474, 975)
        Label9.Margin = New Padding(4, 0, 4, 0)
        Label9.Name = "Label9"
        Label9.Size = New Size(660, 230)
        Label9.TabIndex = 193
        Label9.Text = "24-hour front desk and room service" & vbCrLf & "balconies" & vbCrLf & "restaurant offering local " & vbCrLf & "international cuisine" & vbCrLf & "grocery delivery"
        ' 
        ' Label11
        ' 
        ...
        Label11.Location = New Point(86, 1402)
        Label11.Margin = New Padding(4, 0, 4, 0)
        Label11.Name = "Label11"
        Label11.Size = New Size(1179, 92)
        Label11.TabIndex = 192
        Label11.Text = "The average price varies depending on the season and room type" & vbCrLf & ", generally starting around $40–$50 per night for a standard room."
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(86, 1340)
        ...
        Label8.Location = New Point(86, 975)
        Label8.Margin = New Padding(4, 0, 4, 0)
        Label8.Name = "Label8"
        Label8.Size = New Size(393, 276)
        Label8.TabIndex = 190
        ...
        Label7.Location = New Point(76, 898)
        ...
        Label6.Location = New Point(76, 355)
        Label6.Margin = New Padding(4, 0, 4, 0)
        Label6.Name = "Label6"
        Label6.Size = New Size(1323, 513)
        Label6.TabIndex = 188
        ...
        LinkLabel1.Location = New Point(76, 293)
        LinkLabel1.Margin = New Padding(4, 0, 4, 0)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(555, 54)
        LinkLabel1.TabIndex = 187
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "Charming Miramar Aparthotel"
        ' 
        ' PictureBox6
        ' 
        ...
        PictureBox6.Location = New Point(27, 293)
        ...
        Label5.Font = New Font("Mongolian Baiti", 55F)
        Label5.ForeColor = Color.FromArgb(CByte(98), CByte(62), CByte(42))
        Label5.Location = New Point(4, 163)
        Label5.Margin = New Padding(4, 0, 4, 0)
        Label5.Name = "Label5"
        Label5.Size = New Size(1406, 118)
        Label5.TabIndex = 185
        Label5.Text = "Charming Miramar Aparthotel"
        ' 
        ' PictureBox5
        ' 
        ...
        Label4.Location = New Point(169, 125)
        ...
        Label3.TabIndex = 182
        Label3.Text = "Charming Miramar Aparthotel"
        ' 
        ' Label1
        ' 
        ...
        ' 
        ' Low_Budget_Alex_Hotel_Charming_Miramar_Aparthotel
        ' 
        ...
        Name = "Low_Budget_Alex_Hotel_Charming_Miramar_Aparthotel"
        Text = "Low_Budget_Alex_Hotel_Charming_Miramar_Aparthotel"
