Public Class Landmarks_Hurghada_Royal_Seascope_Submarine
    ...
    Private Sub Landmarks_Hurghada_Royal_Seascope_Submarine_Load(sender As Object, e As EventArgs) Handles MyBase.Load
