Public Class Moderate_Budget_Cairo_Hotels_Al_Masa
    ...
    Private Sub Moderate_Budget_Cairo_Hotels_Al_Masa_Load(sender As Object, e As EventArgs) Handles MyBase.Load
