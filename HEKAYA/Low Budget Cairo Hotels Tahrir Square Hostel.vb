Public Class Low_Budget_Cairo_Hotels_Tahrir_Square_Hostel
    ...
    Private Sub Low_Budget_Cairo_Hotels_Tahrir_Square_Hostel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
