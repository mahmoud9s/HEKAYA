...
Partial Class Hotels_Resorts_Cairo_Small_budget
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Hotels_Resorts_Cairo_Small_budget))
        Label4 = New Label()
        Label3 = New Label()
        Label2 = New Label()
        ...
        PictureBox4.Location = New Point(633, 164)
        ...
        Label1.Location = New Point(720, 70)
        Label1.Name = "Label1"
        ...
        PictureBox6.Location = New Point(98, 12)
        ...
        PictureBox7.Location = New Point(1763, 12)
        ...
        PictureBox5.Location = New Point(1838, 12)
        ...
        PictureBox3.BackgroundImage = My.Resources.Resources._471884825
        ...
        Label8.TabIndex = 60
        Label8.Text = "Tahrir Square Hostel"
        ' 
        ' Label10
        ' 
        ...
        Label10.TabIndex = 62
        Label10.Text = "Miramar Downtown Tahrir Square in Cairo offers renovated rooms, free WiFi, and a central location near Tahrir Square and the Egyptian Museum." & vbCrLf & vbCrLf
        ' 
        ' Label11
        ' 
        ...
        Label11.TabIndex = 63
        Label11.Text = "Tahrir Square Hostel in Cairo offers air-conditioned rooms, free WiFi, a terrace, and a shared kitchen, steps from Tahrir Square and close to key attractions."
        ' 
        ' Label7
        ' 
        ...
        Label7.TabIndex = 69
        Label7.Text = "Pyramids Heart Hotel in Cairo offers air-conditioned rooms, free WiFi, breakfast options, and a terrace. It’s near the Great Sphinx and Giza Pyramids, 20 miles from Cairo Airport."
        ' 
        ' Label9
        ' 
        ...
        Label9.TabIndex = 68
        Label9.Text = "Pyramids Palace Inn in Cairo offers rooms with scenic views, free WiFi, and breakfast options. It’s 1.6 miles from the Giza Pyramids and 19 miles from Cairo Airport."
        ' 
        ' Label12
        ' 
        ...
        Label12.Size = New Size(360, 39)
        Label12.TabIndex = 67
        Label12.Text = "Pyramids Heart Hotel"
        ' 
        ' Label13
        ' 
        ...
        Label13.Size = New Size(349, 39)
        Label13.TabIndex = 66
        Label13.Text = "Pyramids Palace Inn"
        ' 
        ' PictureBox9
        ' 
        ...
        Name = "Hotels_Resorts_Cairo_Small_budget"
        Text = "Hotels_Resorts_Cairo_Small_budget"
