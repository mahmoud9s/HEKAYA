...
Partial Class Hotels_Siwa_Small_budget
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Hotels_Siwa_Small_budget))
        Label14 = New Label()
        ...
        PictureBox12.Location = New Point(340, 163)
        ...
        Label7.TabIndex = 94
        Label7.Text = "M Biama Island in Siwa offers a pool, garden, terrace, restaurant, and bar. Rooms feature wardrobes and include bed linen."
        ' 
        ' Label9
        ' 
        ...
        Label9.TabIndex = 93
        Label9.Text = "The camp offers rooms, tents with scenic views, an outdoor pool, dining area, garden, free Wi-Fi, parking, and bicycle rentals."
        ' 
        ' Label12
        ' 
        ...
        Label12.Size = New Size(266, 39)
        Label12.TabIndex = 92
        Label12.Text = "M Biama Island"
        ' 
        ' Label13
        ' 
        ...
        Label11.TabIndex = 88
        Label11.Text = "Paloma Camp, located 1 km from Siwa's center, offers a peaceful escape into nature with simple, comfortable accommodations in Siwa Oasis."
        ' 
        ' Label10
        ' 
        ...
        Label10.TabIndex = 87
        Label10.Text = "Karam Sands in Siwa offers accommodations with free parking, a garden, terrace, and halal breakfast."
        ' 
        ' Label8
        ' 
        ...
        Label8.Name = "Label8"
        Label8.Size = New Size(244, 39)
        Label8.TabIndex = 86
        Label8.Text = "Paloma Camp"
        ' 
        ' Label6
        ' 
        ...
        Label6.Name = "Label6"
        Label6.Size = New Size(234, 39)
        Label6.TabIndex = 85
        Label6.Text = "Karam Sands"
        ' 
        ' PictureBox10
        ' 
        ...
        Label1.Location = New Point(924, 69)
        Label1.Name = "Label1"
        Label1.Size = New Size(246, 85)
        Label1.TabIndex = 72
        Label1.Text = "Hotels"
        ' 
        ' Hotels_Siwa_Small_budget
        ' 
        ...
        Name = "Hotels_Siwa_Small_budget"
        Text = "Hotels_Siwa_Small_budget"
