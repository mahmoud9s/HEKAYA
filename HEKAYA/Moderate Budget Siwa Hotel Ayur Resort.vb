Public Class Moderate_Budget_Siwa_Hotel_Ayur_Resort
    ...
    Private Sub Moderate_Budget_Siwa_Hotel_Ayur_Resort_Load(sender As Object, e As EventArgs) Handles MyBase.Load
