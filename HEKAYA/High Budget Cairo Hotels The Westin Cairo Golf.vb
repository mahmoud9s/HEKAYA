Public Class High_Budget_Cairo_Hotels_The_Westin_Cairo_Golf
    ...
    Private Sub High_Budget_Cairo_Hotels_The_Westin_Cairo_Golf_Load(sender As Object, e As EventArgs) Handles MyBase.Load
