Public Class Restaurants_AlexFish_Market_Restaurant
    ...
    Private Sub Restaurants_AlexFish_Market_Restaurant_Load(sender As Object, e As EventArgs) Handles MyBase.Load
