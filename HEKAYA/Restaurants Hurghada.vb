Public Class Restaurants_Hurghada
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        Restaurants_Hurghada_Star_Fish_Restaurant.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        Restaurants_Hurghada_Kostalita_restaurant.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub PictureBox4_Click(sender As Object, e As EventArgs) Handles PictureBox4.Click
        Restaurants_Hurghada_Boska_restaurant.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub PictureBox6_Click(sender As Object, e As EventArgs) Handles PictureBox6.Click
        Restaurants_Hurghada_Albalcona_restaurant.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Restaurants_Hurghada_Load(sender As Object, e As EventArgs) Handles MyBase.Load
