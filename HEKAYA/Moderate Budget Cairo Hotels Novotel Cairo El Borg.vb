Public Class Moderate_Budget_Cairo_Hotels_Novotel_Cairo_El_Borg
    ...
    Private Sub Moderate_Budget_Cairo_Hotels_Novotel_Cairo_El_Borg_Load(sender As Object, e As EventArgs) Handles MyBase.Load
