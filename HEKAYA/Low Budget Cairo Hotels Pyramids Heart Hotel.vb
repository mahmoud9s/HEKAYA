Public Class Low_Budget_Cairo_Hotels_Pyramids_Heart_Hotel
    ...
    Private Sub Low_Budget_Cairo_Hotels_Pyramids_Heart_Hotel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
