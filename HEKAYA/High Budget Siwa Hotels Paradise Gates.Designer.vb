...
Partial Class High_Budget_Siwa_Hotels_Paradise_Gates
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(High_Budget_Siwa_Hotels_Paradise_Gates))
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        Label8 = New Label()
        ...
        Label11.Location = New Point(65, 916)
        Label11.Name = "Label11"
        Label11.Size = New Size(275, 31)
        Label11.TabIndex = 124
        Label11.Text = "$80 to $100  per night"
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(65, 868)
        ...
        Label9.Location = New Point(424, 511)
        Label9.Name = "Label9"
        Label9.Size = New Size(237, 329)
        Label9.TabIndex = 122
        Label9.Text = "Dining:" & vbCrLf & "- Complimentary continental breakfast (7:30 AM–10:30 AM). " & vbCrLf & "- On-site restaurant serving local and international cuisine. "
        ' 
        ' Label8
        ' 
        ...
        Label8.Location = New Point(65, 511)
        Label8.Name = "Label8"
        Label8.Size = New Size(316, 294)
        Label8.TabIndex = 121
        Label8.Text = "Rooms" & vbCrLf & "- Luxury single, double, twin, and triple options available. " & vbCrLf & "- All rooms are non-smoking with private bathrooms " & vbCrLf & "air conditioning, Wi-Fi" & vbCrLf & "and garden views. "
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(57, 461)
        Label7.Name = "Label7"
        ...
        LinkLabel1.Location = New Point(74, 240)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(876, 20)
        LinkLabel1.TabIndex = 118
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "near Siwa Central Square, within close proximity to major landmarks like the Fortress of Shali (0.4 km) and Gebel al-Mawta (1.5 km)."
        ' 
        ' PictureBox6
        ' 
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(359, 58)
        Label5.TabIndex = 116
        Label5.Text = " Paradise Gates"
        ' 
        ' PictureBox5
        ' 
        ...
        Label2.Location = New Point(1773, 105)
        Label2.Name = "Label2"
        ...
        Label12.Location = New Point(667, 511)
        Label12.Name = "Label12"
        Label12.Size = New Size(312, 220)
        Label12.TabIndex = 125
        Label12.Text = "Additional Features:" & vbCrLf & "- Concierge services, 24-hour front desk" & vbCrLf & "express check-in/out.   " & vbCrLf & "- Free private parking and valet service."
        ' 
        ' High_Budget_Siwa_Hotels_Paradise_Gates
        ' 
        ...
        Name = "High_Budget_Siwa_Hotels_Paradise_Gates"
        Text = "High_Budget_Siwa_Hotels_Paradise_Gates"
