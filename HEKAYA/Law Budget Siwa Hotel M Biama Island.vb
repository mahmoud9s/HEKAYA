Public Class Law_Budget_Siwa_Hotel_M_Biama_Island
    ...
    Private Sub Law_Budget_Siwa_Hotel_M_Biama_Island_Load(sender As Object, e As EventArgs) Handles MyBase.Load
