...
Partial Class Moderate_Budget_Cairo_Hotels_Concorde_El_Salam
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Moderate_Budget_Cairo_Hotels_Concorde_El_Salam))
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        Label8 = New Label()
        ...
        Label9.Name = "Label9"
        Label9.Size = New Size(413, 192)
        Label9.TabIndex = 78
        Label9.Text = "Spa" & vbCrLf & "Fitness center" & vbCrLf & "Tea/Coffee Maker in All Rooms" & vbCrLf & "Bar" & vbCrLf
        ' 
        ' Label8
        ' 
        ...
        Label8.TabIndex = 77
        Label8.Text = "2 swimming pools" & vbCrLf & "Free Wifi" & vbCrLf & "Airport shuttle (free)" & vbCrLf & "Family rooms" & vbCrLf & "Private Parking" & vbCrLf & "Good Breakfast" & vbCrLf & vbCrLf
        ' 
        ' Label7
        ' 
        ...
        LinkLabel1.Size = New Size(768, 37)
        LinkLabel1.TabIndex = 74
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "65 Abdel Hamid Badawi St., Heliopolis, Cairo, Egypt- show map"
        ' 
        ' PictureBox6
        ' 
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(721, 91)
        Label5.TabIndex = 72
        Label5.Text = "Concorde El Salam"
        ' 
        ' PictureBox5
        ' 
        ...
        Label3.Location = New Point(152, 64)
        Label3.Name = "Label3"
        Label3.Size = New Size(145, 20)
        Label3.TabIndex = 69
        Label3.Text = "Concorde El Salam"
        ' 
        ' Label2
        ' 
        ...
        ' 
        ' Moderate_Budget_Cairo_Hotels_Concorde_El_Salam
        ' 
        ...
        Name = "Moderate_Budget_Cairo_Hotels_Concorde_El_Salam"
        Text = "Moderate_Budget_Cairo_Hotels_Concorde_El_Salam"
