...
Partial Class High_Budget_Siwa_Hotels_Aghurmi_Siwa_Ecolodge_And_Salt_Cave
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(High_Budget_Siwa_Hotels_Aghurmi_Siwa_Ecolodge_And_Salt_Cave))
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        Label8 = New Label()
        ...
        Label11.Location = New Point(65, 929)
        Label11.Name = "Label11"
        Label11.Size = New Size(253, 31)
        Label11.TabIndex = 102
        Label11.Text = "$38 to $50 per night"
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(65, 881)
        ...
        Label9.Location = New Point(438, 639)
        Label9.Name = "Label9"
        Label9.Size = New Size(475, 186)
        Label9.TabIndex = 100
        Label9.Text = "Swimming Pool:" & vbCrLf & "Eco-Friendly Features: Built" & vbCrLf & " with traditional Siwan" & vbCrLf & " materials such as salt blocks and clay" & vbCrLf & ",emphasizing sustainability. Bar" & vbCrLf & "Excellent Breakfast"
        ' 
        ' Label8
        ' 
        ...
        Label8.Location = New Point(65, 639)
        Label8.Name = "Label8"
        Label8.Size = New Size(367, 155)
        Label8.TabIndex = 99
        Label8.Text = "Accommodation " & vbCrLf & "OptionsFree Wifi" & vbCrLf & "Family rooms" & vbCrLf & "Parking: Free " & vbCrLf & "on-site parking for guestsSpa"
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(57, 589)
        Label7.Name = "Label7"
        ...
        LinkLabel1.Location = New Point(74, 241)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(789, 15)
        LinkLabel1.TabIndex = 96
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "is located in the stunning Siwa Oasis, Egypt. It is positioned along the Marsa Matrouh-Siwa Road**, approximately 4-5 kilometers from Siwa’s center. " & vbLf
        ' 
        ' PictureBox6
        ' 
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(890, 58)
        Label5.TabIndex = 94
        Label5.Text = "Aghurmi Siwa Ecolodge And Salt Cave" & vbLf
        ' 
        ' PictureBox5
        ' 
        ...
        Label3.TabIndex = 91
        Label3.Text = "Aghurmi Siwa Ecolodge And Salt Cave" & vbLf
        ' 
        ' Label2
        ' 
        ...
        ' 
        ' High_Budget_Siwa_Hotels_Aghurmi_Siwa_Ecolodge_And_Salt_Cave
        ' 
        ...
        Name = "High_Budget_Siwa_Hotels_Aghurmi_Siwa_Ecolodge_And_Salt_Cave"
        Text = "High_Budget_Siwa_Hotels_Aghurmi_Siwa_Ecolodge_And_Salt_Cave"
