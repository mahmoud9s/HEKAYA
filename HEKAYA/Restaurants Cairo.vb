Public Class Restaurants_Cairo
    ...
    Private Sub Restaurants_Cairo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        AddPageToHistory(Me.Name)

    End Sub

    Private Sub Label8_Click(sender As Object, e As EventArgs) Handles Label8.Click
        Restaurants_Cairo_The_Grill.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub Label9_Click(sender As Object, e As EventArgs) Handles Label9.Click
        Restaurants_Cairo_Mori_Sushi.Show()
        Me.Hide()
    End Sub
