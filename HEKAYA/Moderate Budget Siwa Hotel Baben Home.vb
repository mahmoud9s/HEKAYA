Public Class Moderate_Budget_Siwa_Hotel_Baben_Home
    Private Sub Moderate_Budget_Siwa_Hotel_Baben_Home_Load(sender As Object, e As EventArgs) Handles MyBase.Load
