Public Class Landmarks_Hurghada_Dolphin_World_Show
    ...
    Private Sub Landmarks_Hurghada_Dolphin_World_Show_Load(sender As Object, e As EventArgs) Handles MyBase.Load
