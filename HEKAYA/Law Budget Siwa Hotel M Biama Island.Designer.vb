...
Partial Class Law_Budget_Siwa_Hotel_M_Biama_Island
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Law_Budget_Siwa_Hotel_M_Biama_Island))
        Label12 = New Label()
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        ...
        Label12.Location = New Point(1771, 104)
        ...
        Label9.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        Label9.Font = New Font("Microsoft Sans Serif", 20F)
        Label9.ForeColor = Color.FromArgb(CByte(98), CByte(62), CByte(42))
        Label9.Location = New Point(327, 548)
        Label9.Name = "Label9"
        Label9.Size = New Size(494, 93)
        Label9.TabIndex = 144
        Label9.Text = "outdoor Pool " & vbCrLf & "family rooms" & vbCrLf & "Tea/ coffee making facilities in all rooms"
        ' 
        ' Label8
        ' 
        Label8.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left
        Label8.AutoSize = True
        Label8.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        Label8.Font = New Font("Microsoft Sans Serif", 20F)
        Label8.ForeColor = Color.FromArgb(CByte(98), CByte(62), CByte(42))
        Label8.Location = New Point(65, 548)
        Label8.Name = "Label8"
        Label8.Size = New Size(256, 217)
        Label8.TabIndex = 143
        Label8.Text = "Non-smoking rooms" & vbCrLf & "room service" & vbCrLf & "restaurant" & vbCrLf & "Free parking" & vbCrLf & "breakfast" & vbCrLf & "bar" & vbCrLf & vbCrLf
        ' 
        ' Label7
        ' 
        Label7.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left
        Label7.AutoSize = True
        Label7.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        Label7.Font = New Font("Microsoft Sans Serif", 24F, FontStyle.Bold)
        Label7.ForeColor = Color.FromArgb(CByte(98), CByte(62), CByte(42))
        Label7.Location = New Point(57, 498)
        Label7.Name = "Label7"
        ...
        ' Label6
        ' 
        Label6.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        ...
        Label6.Location = New Point(57, 262)
        Label6.Name = "Label6"
        Label6.Size = New Size(820, 208)
        Label6.TabIndex = 141
        ...
        LinkLabel1.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        LinkLabel1.Font = New Font("Segoe UI", 9F)
        LinkLabel1.Location = New Point(74, 245)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(809, 15)
        LinkLabel1.TabIndex = 140
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "The camp is about 16 km from Siwa Oasis North Airport, offering convenient access. It is also near historical landmarks such as the ancient Shali Fortress." & vbCrLf
        ' 
        ' PictureBox6
        ' 
        PictureBox6.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        PictureBox6.BackgroundImage = CType(resources.GetObject("PictureBox6.BackgroundImage"), Image)
        PictureBox6.BackgroundImageLayout = ImageLayout.Zoom
        PictureBox6.Cursor = Cursors.Hand
        PictureBox6.Location = New Point(24, 223)
        ...
        Label5.Font = New Font("Mongolian Baiti", 40F)
        Label5.ForeColor = Color.FromArgb(CByte(98), CByte(62), CByte(42))
        Label5.Location = New Point(12, 114)
        Label5.Name = "Label5"
        Label5.Size = New Size(374, 58)
        Label5.TabIndex = 138
        Label5.Text = "M Biama Island"
        ' 
        ' PictureBox5
        ' 
        PictureBox5.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        PictureBox5.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        ...
        PictureBox5.TabIndex = 137
        PictureBox5.TabStop = False
        ' 
        ' Label4
        ' 
        Label4.AutoSize = True
        Label4.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        ...
        Label3.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        ...
        Label3.TabIndex = 135
        Label3.Text = "M Biama Island"
        ' 
        ' PictureBox4
        ' 
        PictureBox4.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        PictureBox4.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        PictureBox4.BackgroundImage = CType(resources.GetObject("PictureBox4.BackgroundImage"), Image)
        PictureBox4.BackgroundImageLayout = ImageLayout.Zoom
        PictureBox4.Cursor = Cursors.Hand
        PictureBox4.Location = New Point(1744, 92)
        ...
        PictureBox3.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        PictureBox3.BackgroundImage = CType(resources.GetObject("PictureBox3.BackgroundImage"), Image)
        PictureBox3.BackgroundImageLayout = ImageLayout.Zoom
        PictureBox3.Cursor = Cursors.Hand
        PictureBox3.Location = New Point(1639, 97)
        ...
        PictureBox2.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        PictureBox2.BackgroundImage = CType(resources.GetObject("PictureBox2.BackgroundImage"), Image)
        PictureBox2.BackgroundImageLayout = ImageLayout.Zoom
        PictureBox2.Cursor = Cursors.Hand
        PictureBox2.Location = New Point(1686, 97)
        ...
        PictureBox1.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        PictureBox1.BackgroundImage = CType(resources.GetObject("PictureBox1.BackgroundImage"), Image)
        PictureBox1.BackgroundImageLayout = ImageLayout.Zoom
        PictureBox1.Cursor = Cursors.Hand
        PictureBox1.Location = New Point(985, 95)
        ...
        ' PictureBox8
        ' 
        PictureBox8.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        ...
        ' PictureBox7
        ' 
        PictureBox7.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        ...
        PictureBox9.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        ...
        PictureBox10.BackColor = Color.FromArgb(CByte(239), CByte(235), CByte(229))
        ...
        ' 
        ' Law_Budget_Siwa_Hotel_M_Biama_Island
        ' 
        ...
        Name = "Law_Budget_Siwa_Hotel_M_Biama_Island"
        Text = "Law_Budget_Siwa_Hotel_M_Biama_Island"
