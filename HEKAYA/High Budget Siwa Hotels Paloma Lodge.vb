...
Public Class High_Budget_Siwa_Hotels_Paloma_Lodge
    Private Sub High_Budget_Siwa_Hotels_Paloma_Lodge_Load(sender As Object, e As EventArgs) Handles MyBase.Load
