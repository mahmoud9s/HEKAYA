Public Class Restaurants_Siwa_Kenooz_Restaurant
    ...
    Private Sub Restaurants_Siwa_Kenooz_Restaurant_Load(sender As Object, e As EventArgs) Handles MyBase.Load
