...
Partial Class Moderate_Budget_Blue_Alex_Hotel
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Moderate_Budget_Blue_Alex_Hotel))
        Label6 = New Label()
        ...
        Label6.Name = "Label6"
        Label6.Size = New Size(789, 188)
        Label6.TabIndex = 97
        Label6.Text = "Blue Alex Hotel is located centrally in Alexandria, offering various apartments suitable for families and individuals. It features sea views and proximity to key attractions and amenities."
        ' 
        ' LinkLabel1
        ' 
        LinkLabel1.AutoSize = True
        LinkLabel1.Font = New Font("Segoe UI", 20F)
        LinkLabel1.Location = New Point(65, 196)
        LinkLabel1.Name = "LinkLabel1"
        LinkLabel1.Size = New Size(197, 37)
        LinkLabel1.TabIndex = 96
        LinkLabel1.TabStop = True
        LinkLabel1.Text = "Blue Alex Hotel"
        ' 
        ' PictureBox6
        ' 
        ...
        PictureBox6.Location = New Point(27, 196)
        ...
        Label5.Name = "Label5"
        Label5.Size = New Size(562, 85)
        Label5.TabIndex = 94
        Label5.Text = "Blue Alex Hotel"
        ' 
        ' PictureBox5
        ' 
        ...
        Label3.Location = New Point(194, 79)
        Label3.Name = "Label3"
        Label3.Size = New Size(117, 20)
        Label3.TabIndex = 91
        Label3.Text = "Blue Alex Hotel"
        ' 
        ' Label1
        ' 
        ...
        Label8.Name = "Label8"
        Label8.Size = New Size(223, 155)
        Label8.TabIndex = 99
        Label8.Text = "washing machine" & vbCrLf & "seating area" & vbCrLf & "TV" & vbCrLf & "elevator access" & vbCrLf & "family rooms"
        ' 
        ' Label11
        ' 
        ...
        Label11.Location = New Point(10, 662)
        Label11.Name = "Label11"
        Label11.Size = New Size(715, 62)
        Label11.TabIndex = 102
        Label11.Text = "Prices range from $70 - $110 per night  " & vbCrLf & "Depending on the type of apartment and number of rooms."
        ' 
        ' Label10
        ' 
        ...
        Label10.Location = New Point(27, 617)
        ...
        Label9.Location = New Point(320, 439)
        Label9.Name = "Label9"
        Label9.Size = New Size(420, 124)
        Label9.TabIndex = 103
        Label9.Text = "Air conditioning toiletries           " & vbCrLf & "balcony with sea or city views       " & vbCrLf & "hairdryer           " & vbCrLf & "Parking"
        ' 
        ' Label2
        ' 
        ...
        ' 
        ' Moderate_Budget_Blue_Alex_Hotel
        ' 
        ...
        Name = "Moderate_Budget_Blue_Alex_Hotel"
        Text = "Moderate_Budget_Blue_Alex_Hotel"
