Public Class Low_Budget_Alex_Hotel_Flores_Casas_de_Playa
    ...
    Private Sub Low_Budget_Alex_Hotel_Flores_Casas_de_Playa_Load(sender As Object, e As EventArgs) Handles MyBase.Load
